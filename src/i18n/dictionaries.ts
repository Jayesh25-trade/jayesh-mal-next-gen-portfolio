...
const en: Dict = {
  ...
  hero: {
    ...
    title1: "We build next-generation",
    title2: "websites & web apps",
    subtitle: "Fast, scalable, and designed to convert.",
    ctaWork: "View Work", ctaContact: "Contact Us",
  },
  values: {
  ...
  stack: { title: "Tech stack", subtitle: "The tools we reach for every day." },
  contact: {
    ...
    send: "Send message", whatsapp: "Chat on WhatsApp", emailMe: "Email us",
    sent: "Thanks — opening your email client.",
  },
  footer: "Designed and built by Jimmzzz Developers",
...
export const DICTS: Record<LangCode, Dict> = {
  ...
  hi: make({
    ...
    hero: { badge: "नए प्रोजेक्ट के लिए उपलब्ध", title1: "हम बनाते हैं अगली पीढ़ी की", title2: "वेबसाइट्स और वेब ऐप्स", subtitle: "तेज़, स्केलेबल और कन्वर्ज़न के लिए डिज़ाइन की गई।", ctaWork: "काम देखें", ctaContact: "संपर्क करें" },
    values: { title: "हमारे साथ क्यों काम करें", subtitle: "आधुनिक इंजीनियरिंग और बिज़नेस रिज़ल्ट्स।",
      items: [
    ...
    footer: "Jimmzzz Developers द्वारा डिज़ाइन और निर्मित",
  ...
  mr: make({
    ...
    hero: { badge: "नवीन प्रोजेक्टसाठी उपलब्ध", title1: "आम्ही बनवतो पुढच्या पिढीच्या", title2: "वेबसाइट्स आणि वेब अ‍ॅप्स", subtitle: "वेगवान, स्केलेबल आणि कन्व्हर्जनसाठी डिझाइन केलेले.", ctaWork: "काम पहा", ctaContact: "संपर्क करा" },
    values: { title: "आमच्यासोबत का काम करावे", subtitle: "आधुनिक इंजिनिअरिंग आणि व्यवसाय परिणाम.",
      items: [
    ...
    footer: "Jimmzzz Developers द्वारे डिझाइन आणि बनवलेले",
  ...
  es: make({
    ...
    hero: { badge: "Disponible para nuevos proyectos", title1: "Construimos sitios web", title2: "y apps de nueva generación", subtitle: "Rápidos, escalables y diseñados para convertir.", ctaWork: "Ver trabajos", ctaContact: "Contáctanos" },
    values: { title: "Por qué trabajar con nosotros", subtitle: "Ingeniería moderna con resultados de negocio.", items: en.values.items },
    ...
    stack: { title: "Stack tecnológico", subtitle: "Las herramientas que usamos a diario." },
    contact: { ...en.contact, title: "Construyamos algo poderoso", subtitle: "Cuéntanos de tu proyecto — respondemos en pocas horas.", name: "Tu nombre", email: "Tu email", message: "Tu mensaje", send: "Enviar mensaje", whatsapp: "Chatear por WhatsApp", emailMe: "Envíanos un email", sent: "Gracias — abriendo tu cliente de email." },
    footer: "Diseñado y construido por Jimmzzz Developers",
  ...
  fr: make({
    ...
    hero: { badge: "Disponible pour de nouveaux projets", title1: "Nous créons des sites web", title2: "et apps nouvelle génération", subtitle: "Rapides, évolutifs et conçus pour convertir.", ctaWork: "Voir les projets", ctaContact: "Nous contacter" },
    values: { title: "Pourquoi travailler avec nous", subtitle: "Ingénierie moderne et résultats business.", items: en.values.items },
    ...
    stack: { title: "Stack technique", subtitle: "Les outils que nous utilisons au quotidien." },
    contact: { ...en.contact, title: "Construisons quelque chose de puissant", subtitle: "Parlez-nous de votre projet.", name: "Votre nom", email: "Votre email", message: "Votre message", send: "Envoyer", whatsapp: "Discuter sur WhatsApp", emailMe: "Nous envoyer un email", sent: "Merci — ouverture de votre messagerie." },
    footer: "Conçu et développé par Jimmzzz Developers",
